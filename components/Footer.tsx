...
// Only profiles with a URL in lib/site.ts are rendered — no dead "#" links.
const socialLinks = [
  { label: "iNOVAA on LinkedIn", href: site.social.linkedin, icon: Briefcase },
  { label: "iNOVAA on X", href: site.social.x, icon: AtSign },
  { label: "iNOVAA on Instagram", href: site.social.instagram, icon: Camera },
].filter((l) => l.href);
        ...
        <div className="grid gap-10 py-14 lg:grid-cols-[1.2fr_1fr_1.4fr_1fr_1fr] lg:gap-0">
          <div className="lg:pr-8">
            ...
            <p className="mt-3 text-sm text-footer-muted">
              <a href={`mailto:${site.email}`} className="hover:text-footer-fg">
                {site.email}
              </a>
            </p>
